...
export function OrgHealthPanel({ open, onClose }: OrgHealthPanelProps) {
  ...
  return (
    <div className="absolute right-4 top-4 bottom-4 z-40 flex w-[360px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl [transform:translateZ(0)] dark:border-white/10 dark:bg-slate-900">
      ...
      <div className="flex-1 overflow-y-auto p-4 [transform:translateZ(0)]">
