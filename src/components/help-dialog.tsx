...
const SHORTCUT_GROUPS: ShortcutGroup[] = [
  {
    ...
    items: [
      ...
      { keys: ["1"], label: "Senior team view" },
      { keys: ["2"], label: "Brand view" },
      { keys: ["3"], label: "Channel view" },
      { keys: ["4"], label: "Department view" },
      { keys: ["5"], label: "Grid view" },
      { keys: ["0"], label: "Fit everything to view" },
      { keys: ["Click manager"], label: "Open that person's org view" },
      { keys: ["Esc"], label: "Step back — close panel, then exit a team view" },
      { keys: ["+"], label: "Zoom in" },
      { keys: ["−"], label: "Zoom out" },
    ],
  },
