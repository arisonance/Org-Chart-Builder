...
export function UnitRail({
  ...
  return (
    <div className="absolute left-4 top-[4.75rem] bottom-4 z-30 flex w-64 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white/95 shadow-xl backdrop-blur dark:border-white/10 dark:bg-slate-900/92">
      <div className="border-b border-slate-200 px-3 py-2.5 dark:border-white/10">
        ...
        <p className="text-[10px] text-slate-400">
          {rolledHeadcount} people rolled up · off the lanes
        </p>
      </div>
